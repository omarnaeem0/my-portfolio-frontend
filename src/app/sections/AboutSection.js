...
export default function AboutSection() {
  return (
    <div className="text-center lg:p-2 py-16">
      ...
      <div className="flex flex-row justify-center gap-12 flex-wrap py-6 px-4 lg:px-10 max-w-5xl m-auto">
      ...
      <div className="flex flex-row justify-between flex-wrap py-6 px-4 lg:px-10 max-w-5xl m-auto">
        {about.mainHighlights.map((highlight) => (
          <div key={highlight.title}>
            <h3 className="text-gray-900 dark:text-white font-bold text-2xl mb-2">
              {highlight.value}
            </h3>
            <p className="text-gray-900 dark:text-white text-md w-24">
              {highlight.title}
            </p>
          </div>
        ))}
