          ...
          <div className='flex justify-evenly flex-col lg:flex-row items-center'>
            <div className='lg:max-w-lg'>
              <div className='text-center lg:p-10'>
                <h2 className='text-4xl lg:text-5xl py-2 lg:py-4 text-teal-500 font-medium '>Omar Naeem</h2>
              ...
              <div className='text-3xl lg:text-4xl flex justify-center gap-10 lg:gap-12 py-3 text-gray-600'>
                <AiFillLinkedin />
                <AiFillGithub />
              </div>
            </div>
            <div className='relative bg-gradient-to-r from-cyan-500 to-teal-500 rounded-full overflow-hidden w-60 lg:w-80 h-60 lg:h-80 mt-10 lg:mt-20'>
